...
module.exports = function(options) {
    return {
         ...
         * karma-webpack
         * 
         * Do not change, leave as is or it wont work. See:
        ...
        module : {
            ...
            preLoaders : [
                    ...
                    /**
                     * Source map loader support for *.js files Extracts
                     ...
                     */
                    {
                        ...
                        exclude : [
                                // these packages have problems with their
                                // sourcemaps
             ...
             * which they are applied to. This means they are not resolved
            ...
            loaders : [
                     ...
                     */
                    {
                        ...
                        query : {
                            // use inline sourcemaps for "karma-remap-coverage"
                            // reporter
                            sourceMap : false,
                    ...
                    /**
                     * Raw loader support for *.css files Returns file content
                     * as string
                     * 
                    ...
                    // See https://github.com/webpack/css-loader/issues/38
                    {
            ...
            postLoaders : [
                ...
                /**
                 * Instruments JS files with Istanbul for subsequent code
                 * coverage reporting. Instrument only testing sources.
                 * 
                 * See:
        ...
        plugins : [
                 ...
                 * Useful for having development builds with debug logging or
                 ...
                 */
                // NOTE: when adding more properties make sure you include them
