...
module.exports = function(config) {
    ...
    var configuration = {
         ...
         * 
         * possible values: 'dots', 'progress' available reporters:
        ...
        /*
         * level of logging possible values: config.LOG_DISABLE ||
         * config.LOG_ERROR || config.LOG_WARN || config.LOG_INFO ||
         * config.LOG_DEBUG
         */
        ...
        /*
         * Continuous Integration mode if true, Karma captures browsers, runs
         * the tests and exits
         */
        singleRun : true
    };
